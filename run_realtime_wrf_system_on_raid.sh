...
echo
.  /home/wjc/.bash_profile ; /home/wjc/miniconda3/bin/python /projects/SD_Mines_WRF_REALTIME/WRF_Backbone_Scrip_on_raid.py > /projects/SD_Mines_WRF_REALTIME/wrf_log_${DATESTRING}.log 2>&1
