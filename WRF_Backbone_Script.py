...
with open(WRF_OVERALL_DIR + "./wrf_post_processing.sh", 'w') as f:
    ...
    print("(. source ~/.bashrc ;  python " + WRF_OVERALL_DIR+ "./tslist_to_netcdf.py > ./TS2NC."     + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  && python " + WRF_OVERALL_DIR + "./plot_tslist_meteograms.py > ./METOGRAMS." + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
    print("(. source ~/.bashrc ;   python " + WRF_OVERALL_DIR+ "./plot_maps_d01.py    > ./MAPS_D01."  + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
    print("(. source ~/.bashrc ;   python " + WRF_OVERALL_DIR+ "./plot_maps_d02.py    > ./MAPS_D02."  + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
    # print("(. source ~/.bashrc ;   python " + WRF_OVERALL_DIR+ "./plot_maps_d03.py    > ./MAPS_D03."  + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
    print("(. source ~/.bashrc ;   python " + WRF_OVERALL_DIR+ "./plot_skewt_d01.py   > ./SKEWT_D01." + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
    print("(. source ~/.bashrc ;   python " + WRF_OVERALL_DIR+ "./plot_skewt_d02.py   > ./SKEWT_D02." + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
    # print("(. source ~/.bashrc ;   python " + WRF_OVERALL_DIR+ "./plot_skewt_d03.py   > ./SKEWT_D03." + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
    print("(. source ~/.bashrc ;   " + WRF_OVERALL_DIR + "namelist_files_and_local_scripts/run_unipost_frames_SDMines > ./UPP."+model_start_date_YYYY_MM_DD_HH+".LOG 2>&1  ) & ", file =  f) 
    print("wait", file =  f) 
