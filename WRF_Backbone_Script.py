...
with open(WRF_OVERALL_DIR + "./wrf_post_processing.sh", 'w') as f:
    ...
    print("(.  ~/.bashrc ;  /home/wjc/miniconda3/bin/python " + WRF_OVERALL_DIR+ "./tslist_to_netcdf.py > ./TS2NC."     + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1 ;  source ~/.bashrc ;   /home/wjc/miniconda3/bin/python " + WRF_OVERALL_DIR + "./plot_tslist_meteograms.py > ./METOGRAMS." + model_start_date_YYYY_MM_DD_HH + ".LOG 2>&1  ) & ", file =  f) 
